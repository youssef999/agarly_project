...
import 'package:airbnb_clone/screens/details_screen.dart';
import 'package:airbnb_clone/screens/host_details_screen.dart';
...
class _PropertyCardState extends State<PropertyCard> {
  ...
  MaterialPageRoute(builder: (context) =>  DetailsScreen(
    image: widget.property.photoUrls[0],
    title: widget.property.country,
    des: widget.property.description,
    place:widget.property.city ,
    price:widget.property.pricePerNight.toString() ,
  )),
);
           },
     );
